...
/**
 * Created by rick on 5/3/16.
 */
public class YamlBeanConfigLoaderTest {

    private Config config;

    @Test
    public void testYamlSimple() {

        final Config config = yamlBeanConfig("reference.yaml");
    ...
    public void setUp() throws Exception {
        config = configs(yamlBeanConfig("reference.yaml"), config("test-config.js"));
    }
    ...
    public void testGetMap() throws Exception {
        ...
        assertEquals("2",  map.get("int2"));
        assertEquals("2.01",  map.get("float2"));
